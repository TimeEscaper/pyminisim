...
from pyminisim.pedestrians import HeadedSocialForceModelPolicy, RandomWaypointTracker, FixedWaypointTracker, ETHPedestriansRecord
...
def create_sim() -> Tuple[Simulation, Renderer]:
    ...
    #                                                                          [3., 3., 0.]]))
    pedestrians_model = ETHPedestriansRecord(dt=0.01)
